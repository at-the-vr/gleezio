...
type InputProps = React.InputHTMLAttributes<HTMLInputElement> & {label?:string, description?:string}

export const Input: React.FC<InputProps> = ({ className, label, description, ...props }) => {
	// Base classes
